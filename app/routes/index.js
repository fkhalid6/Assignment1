...
router.get('/projects', function(req, res, next) { 
  res.render('projects-services', { //for the route "/projects", render the project-services view
    ...
    title: 'My Projects',
    introPara: 'Welcome to my portfolio which showcases selected projects that provide a glimpse into my professional capabilities. These projects exemplify my rapid progression and aptitude for quick learning over the past nine months. Their inclusion underscores their effectiveness in illustrating my capacity to advance swiftly within my field. Each endeavor represents a distinctive journey, underscoring my unwavering commitment to excellence in my chosen profession.',
    paraheader: 'Project',
